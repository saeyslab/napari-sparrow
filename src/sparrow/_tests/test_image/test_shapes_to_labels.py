...
from sparrow.image import add_label_layer_from_shapes_layer
from sparrow.shape import _add_shapes_layer


def test_add_label_layer_from_shapes_layer(sdata_multi_c):
    ...
    sdata_multi_c = add_label_layer_from_shapes_layer(
        sdata_multi_c,
