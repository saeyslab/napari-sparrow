        ...
        (
            ...
            Step(
                ...
                (
                    ...
                    "- path image: select the path to the image, can be single channel or multi-channel.\n"
                    "- output dir: select the output directory, where all figures and files generated by sparrow will be written.\n"
                    "- x_min, x_min, x_max, y_min and y_max (optional): select cropping region, recommended for large images."
                ),
            ),
        ),
        (
