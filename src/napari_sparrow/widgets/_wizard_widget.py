        ...
        (
            ...
            Step(
                ...
                (
                    ...
                    "- path zarr: select the path to a zarr store containing a SpatialData object.\n"
                    "- path image: select the path to an image, can be single channel or multi-channel. Will be ignored if path zarr is set.\n"
                    "- image layer: the image layer in the zarr store on which to run sparrow, or the image layer in the zarr store that will be created if a path to an image is given.\n"
                    "- output dir: select the output directory, where all figures and files generated by sparrow will be written.\n"
